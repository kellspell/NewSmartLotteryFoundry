...
contract RaffleTest is StdCheats, Test {
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        // Arrange
        vm.prank(PLAYER);                               // Pretende to be the participant
        raffle.enterRaffle{value: raffleEntranceFee}();
        vm.warp(block.timestamp + automationUpdateInterval + 1); // This let you to set the block.timestamp
        vm.roll(block.number + 1);                                  // This let you to set the block.number
